...
function myResult(){
	...
	else if(option_from === "meter" && option_to==="MiliMeater")
	{
	...
	else if(option_from === "kilometer" && option_to==="MiliMeater")
	{
	...
	else if(option_from === "Centimeter" && option_to==="MiliMeater")
	{
	...
	if(option_from === "MiliMeater" && option_to==="kilometer")
	{
		result.value = Number(input.value) *0.000001;
	}
	else if(option_from === "MiliMeater" && option_to==="meter")
	{
		result.value = Number(input.value) * (0.001);
	}
	else if(option_from === "MiliMeater" && option_to==="Centimeter")
	{
		result.value = Number(input.value) *0.1;
	}
	else if(option_from === "MiliMeater" && option_to==="MiliMeater")
	{
		result.value = input.value
